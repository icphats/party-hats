export const idlFactory = ({ IDL }) => {
    ...
    const AssetGenerativeMetadata = IDL.Record({
      'trait_category_name' : IDL.Text,
      'trait_category_id' : IDL.Text,
      'layer_index' : IDL.Nat64,
      'asset_index_within_layer' : IDL.Nat64,
    });
    const AssetData = IDL.Tuple(IDL.Nat64, IDL.Text);
    const LayerData = IDL.Tuple(IDL.Nat64, IDL.Text, IDL.Vec(AssetData));
    const ResultData = IDL.Vec(LayerData);
    ...
    return IDL.Service({
      '_getAssetGenerativeMetadata' : IDL.Func(
          [],
          [IDL.Vec(IDL.Tuple(AssetHandle, AssetGenerativeMetadata))],
          ['query'],
        ),
      '_returnFirstPartOfFilterJSON' : IDL.Func([], [IDL.Text], ['query']),
      '_testFilters' : IDL.Func([IDL.Nat], [ResultData], ['query']),
      'acceptCycles' : IDL.Func([], [], []),
      'addAsset' : IDL.Func(
          [AssetHandle, IDL.Text, IDL.Nat64, IDL.Nat64, IDL.Text, IDL.Text],
          [IDL.Text],
          [],
        ),
      ...
      'ext_assetAdd' : IDL.Func([IDL.Text, IDL.Text], [IDL.Text], []),
      ...
      'ext_saleModifyGroupPricing' : IDL.Func(
          [IDL.Text, IDL.Vec(IDL.Tuple(IDL.Nat64, IDL.Nat64))],
          [IDL.Bool],
          [],
        ),
      'ext_saleModifyGroupTimes' : IDL.Func(
          [IDL.Text, Time, Time],
          [IDL.Bool],
          [],
        ),
      ...
      'returnEntrepotFilters' : IDL.Func(
          [IDL.Nat, IDL.Nat],
          [IDL.Text],
          ['query'],
        ),
      ...
      'setNumberOfGenerativeLayers' : IDL.Func([IDL.Nat], [], ['oneway']),
